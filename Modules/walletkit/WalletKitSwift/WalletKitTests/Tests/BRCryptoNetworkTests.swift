...
class BRCryptoNetworkTests: XCTestCase {
    ...
    func testNetworkBTC () {
        ...
        let BTC_SATOSHI = WalletKit.Unit (currency: btc, code: "sat",  name: "Satoshi", symbol: "SAT")
        let BTC_BTC     = WalletKit.Unit (currency: btc, code: "btc",  name: "Bitcoin", symbol: "B", base: BTC_SATOSHI, decimals: 8)
    ...
    func testNetworkETH () {
        let eth = Currency (uids: "ethereum-mainnet:__native__", name: "Ethereum", code: "eth", type: "native", issuer: nil)
        let ETH_WEI   = WalletKit.Unit (currency: eth, code: "wei", name: "WEI",   symbol: "wei")
        let ETH_GWEI  = WalletKit.Unit (currency: eth, code: "gwei", name: "GWEI",  symbol: "gwei", base: ETH_WEI, decimals: 9)
        let ETH_ETHER = WalletKit.Unit (currency: eth, code: "eth", name: "ETHER", symbol: "E",    base: ETH_WEI, decimals: 18)

        let brd = Currency (uids: "ethereum-mainnet:0x558ec3152e2eb2174905cd19aea4e34a23de9ad6", name: "X-Wallet Token", code: "brd", type: "erc20", issuer: "0x558ec3152e2eb2174905cd19aea4e34a23de9ad6")
        // let brd_brdi = WalletKit.Unit (currency: brd, uids: "BRDI", name: "BRD Token INT", symbol: "BRDI")
        // let brd_brd  = WalletKit.Unit (currency: brd, uids: "BRD",  name: "BRD Token",     symbol: "BRD", base: brd_brdi, decimals: 18)
