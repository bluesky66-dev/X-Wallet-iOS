...
""".utf8)
    ...
    static var brd: AppCurrency {
        ...
        let brd = CoreCurrency (uids: Currencies.brd.uid.rawValue, name: "X-Wallet Token", code: Currencies.brd.code, type: "erc20", issuer: "0x558ec3152e2eb2174905cd19aea4e34a23de9ad6")
