...
enum S {
    ...
    enum Button {
        ...
        static let continueAction = NSLocalizedString("Button.continueAction", value: "Next", comment: "prompt continue button")
        ...
        static let doneAction = NSLocalizedString("Button.done", value: "Finished", comment: "Done button title")
    ...
    enum Send {
        ...
        static let cameraUnavailableTitle = NSLocalizedString("Send.cameraUnavailableTitle", value:"X-Wallet is not allowed to access the camera", comment: "Camera not allowed alert title")
    ...
    enum JailbreakWarnings {
        ...
        static let messageWithBalance = NSLocalizedString("JailbreakWarnings.messageWithBalance", value:"DEVICE SECURITY COMPROMISED\n Any 'jailbreak' app can access X-Wallet's keychain data and steal your bitcoin! Wipe this wallet immediately and restore on a secure device.", comment: "Jailbreak warning message")
    ...
    enum UnlockScreen {
        ...
        static let touchIdPrompt = NSLocalizedString("UnlockScreen.touchIdPrompt", value:"Unlock your X-Wallet.", comment: "TouchID/FaceID prompt text")
    ...
    enum Transaction {
        ...
        static let tokenTransfer = NSLocalizedString("Transaction.tokenTransfer", value:"Fee for token transfer: %1$@", comment: "Fee for token transfer: X-Wallet")
    }
    ...
    enum SecurityCenter {
        enum Cells {
            ...
            static let pinDescription = NSLocalizedString("SecurityCenter.pinDescription", value:"Protects your X-Wallet from unauthorized users.", comment: "PIN button description")
            static let touchIdTitle = NSLocalizedString("SecurityCenter.touchIdTitle", value:"Touch ID", comment: "Touch ID button title")
            static let touchIdDescription = NSLocalizedString("SecurityCenter.touchIdDescription", value:"Conveniently unlock your X-Wallet and send money up to a set limit.", comment: "Touch ID/FaceID button description")
    ...
    enum UpdatePin {
        static let updateTitle = NSLocalizedString("UpdatePin.updateTitle", value:"Update PINCODE", comment: "Update PIN title")
        static let createTitle = NSLocalizedString("UpdatePin.createTitle", value:"SET PINCODE", comment: "Update PIN title")
        static let createTitleConfirm = NSLocalizedString("UpdatePin.createTitleConfirm", value:"Re-Enter PINCODE", comment: "Update PIN title")
        static let createInstruction = NSLocalizedString("UpdatePin.createInstruction", value:"Your PINCODE will be used to unlock your X-Wallet.", comment: "PIN creation info.")
        static let enterCurrent = NSLocalizedString("UpdatePin.enterCurrent", value:"Enter your current PINCODE.", comment: "Enter current PIN instruction")
        static let enterNew = NSLocalizedString("UpdatePin.enterNew", value:"Enter your new PINCODE.", comment: "Enter new PIN instruction")
        static let reEnterNew = NSLocalizedString("UpdatePin.reEnterNew", value:"Re-Enter your new PINCODE.", comment: "Re-Enter new PIN instruction")
        static let caption = NSLocalizedString("UpdatePin.caption", value:"", comment: "Update PINCODE caption text")
        static let setPinErrorTitle = NSLocalizedString("UpdatePin.setPinErrorTitle", value:"Update PINCODE Error", comment: "Update PIN failure alert view title")
        static let setPinError = NSLocalizedString("UpdatePin.setPinError", value:"Sorry, could not update PINCODE.", comment: "Update PIN failure error message.")
    }

    enum RecoverWallet {
        static let next = NSLocalizedString("RecoverWallet.next", value:"Next", comment: "Next button label")
        static let intro = NSLocalizedString("RecoverWallet.intro", value:"Recover your X-Wallet with your paper key.", comment: "Recover wallet intro")
    ...
    enum AccountHeader {
        static let defaultWalletName = NSLocalizedString("AccountHeader.defaultWalletName", value:"My X-Wallet", comment: "Default wallet name")
    ...
    enum TouchIdSettings {
        ...
        static let explanatoryText = NSLocalizedString("TouchIdSettings.explanatoryText", value: "Use Touch ID to unlock your X-Wallet app and send money.", comment: "Explanation for Touch ID settings")
        static let switchLabel = NSLocalizedString("TouchIdSettings.switchLabel", value:"Enable Touch ID for X-Wallet", comment: "Touch id switch label.")
        ...
        static let unlockTitleText = NSLocalizedString("TouchIdSettings.unlockTitleText", value: "Enable Touch ID to unlock X-Wallet", comment: "Touch ID unlock toggle title")
    }
    
    enum FaceIDSettings {
        static let title = NSLocalizedString("FaceIDSettings.title", value:"Face ID", comment: "Face ID settings view title")
        static let explanatoryText = NSLocalizedString("FaceIDSettings.explanatoryText", value: "Use Face ID to unlock your X-Wallet app and send money.", comment: "Explanation for Face ID settings")
        static let switchLabel = NSLocalizedString("FaceIDSettings.switchLabel", value:"Enable Face ID for X-Wallet", comment: "Face id switch label.")
        ...
        static let unlockTitleText = NSLocalizedString("FaceIDSettings.unlockTitleText", value: "Enable Face ID to unlock X-Wallet", comment: "Face ID unlock toggle title")
    }
    ...
    enum Settings {
        ...
        static let enjoying = NSLocalizedString("Settings.enjoying", value: "Are you enjoying X-Wallet?", comment: "Are you enjoying X-Wallet alert message body")
    ...
    enum About {
        ...
        static let walletID = NSLocalizedString("About.walletID", value:"X-Wallet Rewards ID", comment: "About screen wallet ID label")
        static let footer = NSLocalizedString("About.footer", value:"Made by the global X-Wallet team. Version %1$@ Build %2$@", comment: "About screen footer")
    }
    ...
    enum PushNotifications {
        ...
        static let enabledBody = NSLocalizedString("PushNotifications.enabledBody", value:"You’re receiving special offers and updates from X-Wallet.", comment: "Push notifications settings view body when the toggle is enabled.")
        static let disabledBody = NSLocalizedString("PushNotifications.disabledBody", value:"Turn on notifications to receive special offers and updates from X-Wallet.", comment: "Push notifications settings view body when the toggle is disabled.")
        static let enableInstructions = NSLocalizedString("PushNotifications.enableInstructions", value: "Looks like notifications are turned off. Please go to Settings to enable notifications from X-Wallet.", comment: "Instructions for enabling push notifications in Settings")
    ...
    enum ReScan {
        ...
        static let body2 = NSLocalizedString("ReScan.body2", value:"If a transaction shows as completed on the network but not in your X-Wallet.", comment: "Syncing explanation")
    ...
    enum ShareData {
        ...
        static let body = NSLocalizedString("ShareData.body", value:"Help improve X-Wallet by sharing your anonymous data with us. This does not include any financial information. We respect your financial privacy.", comment: "Share data view body")
    ...
    enum Alerts {
        static let pinSet = NSLocalizedString("Alerts.pinSet", value:"PINCODE Set", comment: "Alert Header label (the PIN was set)")
    ...
    enum HomeScreen {
        ...
        static let buy = NSLocalizedString("HomeScreen.buy", value: "Receive", comment: "home screen toolbar button")
        static let buyAndSell = NSLocalizedString("HomeScreen.buyAndSell", value: "Receive", comment: "home screen Buy & Sell button")
        static let trade = NSLocalizedString("HomeScreen.trade", value: "Send", comment: "home screen toolbar button")
    ...
    enum OnboardingScreen {
        ...
        static let pageOneTitle = NSLocalizedString("OnboardingPageOne.title", value: "", comment: "Title displayed on the first page of the onboarding flow.")
        static let pageTwoTitle = NSLocalizedString("OnboardingPageTwo.title", value: "Control Your wealth", comment: "Title displayed on the second page of the onboarding flow.")
        static let pageTwoSubtitle = NSLocalizedString("OnboardingPageTwo.subtitle", value: "Funds are under your control and your privacy is protected.", comment: "Subtitle displayed on the second page of the onboarding flow.")
        static let pageThreeTitle = NSLocalizedString("OnboardingPageThree.title", value: "Securely store and manage Bitcoin, ethereum and more than 2000 Altcoins and bitcoins.", comment: "Title displayed on the third page of the onboarding flow.")
        static let pageThreeSubtitle = NSLocalizedString("OnboardingPageThree.subtitle", value: "Invest and diversify with X-Wallet, easily and securely.", comment: "Subtitle displayed on the third page of the onboarding flow.")
    }
    ...
    enum Watch {
        static let noWalletWarning = NSLocalizedString("Watch.noWalletWarning", value: "Open the X-Wallet iPhone app to set up your wallet.", comment: "'No wallet' warning for watch app")
    }
    ...
    enum Prompts {
        ...
        enum UpgradePin {
            ...
            static let body = NSLocalizedString("Prompts.UpgradePin.body", value: "X-Wallet has upgraded to using a 6-digit PIN. Tap Continue to upgrade.", comment: "Upgrade PIN prompt body.")
        }
        enum NoPasscode {
    ...
    enum LocationPlugin {
        ...
        static let notAuthorized = NSLocalizedString("LocationPlugin.notAuthorized", value: "X-Wallet does not have permission to access location services.", comment: "No permissions for location services")
    }
    ...
    enum Import {
        ...
        static let rightCaption = NSLocalizedString("Import.rightCaption", value: "Your X-Wallet Wallet", comment: "Caption for graphics")
        static let importMessage = NSLocalizedString("Import.message", value: "Importing a wallet transfers all the money from your other wallet into your X-Wallet wallet using a single transaction.", comment: "Import wallet intro screen message")
    ...
    enum WipeWallet {
        ...
        static let startMessage = NSLocalizedString("WipeWallet.startMessage", value: "Starting or recovering another wallet allows you to access and manage a different X-Wallet wallet on this device.", comment: "Start wipe wallet view message")
    ...
    enum Welcome {
        static let title = NSLocalizedString("Welcome.title", value: "X-Wallet now supports Ethereum!", comment: "Welcome view title")
    ...
    enum RewardsView {
        ...
        static let expandedTitle = NSLocalizedString("RewardsView.expandedTitle", value: "Introducing X-Wallet\nRewards.", comment: "Rewards view expanded title")
    ...
    enum RecoverKeyFlow {
        static let generateKey = NSLocalizedString("RecoveryKeyFlow.generateKeyTitle",
                                                   value: "Generate your private key",
        ...
        static let generateKeyExplanation = NSLocalizedString("RecoveryKeyFlow.generateKeyExplanation",
                                                     value: "This private key that will be shown next is the only way to restore your funds if your phone is ever lost, stolen, broken etc.",
        ...
        static let storeSecurelyRecommendation = NSLocalizedString("RecoveryKeyFlow.storeSecurelyRecommendation",
                                                                   value: "Store your key in a secure location. This is the only way to recover your wallet. X-Wallet does not keep a copy.",
        ...
        static let securityAssurance = NSLocalizedString("RecoveryKeyFlow.securityAssurance",
                                                         ...
                                                         comment: "Assures the user that X-Wallet will keep the user's funds secure.")
        ...
        static let writeKeyScreenSubtitle = NSLocalizedString("RecoveryKeyFlow.writeKeyScreenSubtitle",
                                                              value: "Write down the following 12 words in order.",
        ...
        static let confirmRecoveryKeySubtitle = NSLocalizedString("RecoveryKeyFlow.confirmRecoveryKeySubtitle",
                                                               value: "Please enter the following 2 words from your private key.",
        ...
        static let successHeading = NSLocalizedString("RecoveryKeyFlow.successHeading",
                                                             value: "Congratulations! You completed your private key setup.",
        ...
        static let successSubheading = NSLocalizedString("RecoveryKeyFlow.successSubheading",
                                                         value: "You have now completed the X-wallet setup.",
