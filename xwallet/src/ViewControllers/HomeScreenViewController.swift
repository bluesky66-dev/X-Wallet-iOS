...
class HomeScreenViewController: UIViewController, Subscriber, Trackable {
    ...
    private let logo = UIImageView(image: UIImage(named: "XLogoSmall"))
    ...
    private func addConstraints() {
        ...
        subHeaderView.constrain([
            subHeaderView.leadingAnchor.constraint(equalTo: view.leadingAnchor),
                                    subHeaderView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 25.0),
...
//            totalAssetsLabel.bottomAnchor.constraint(equalTo: total.topAnchor)])
        ...
        logo.constrain([
            ...
            logo.centerYAnchor.constraint(equalTo: subHeaderView.topAnchor)])
