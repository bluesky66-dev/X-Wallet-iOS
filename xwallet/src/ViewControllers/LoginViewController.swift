...
//    private var logo = UIImageView(image: #imageLiteral(resourceName: "LogoCutout").withRenderingMode(.alwaysTemplate))
    private var logo = UIImageView(image: UIImage(named: "XLogoLarge"))
...
//    private let logoBackground = Theme.primaryBackground
...
//        logo.constrain(toSuperviewEdges: nil)
        ...
        logo.frame = CGRect(x: 0, y: 0, width: screensize.width * 0.8, height: screensize.height * 0.4)
        logo.constrain([
        logo.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: 10),
        logo.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: -(offset))
        ])
