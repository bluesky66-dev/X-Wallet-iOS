...
class RecoveryKeyLandingPageCell: RecoveryKeyPageCell {
    ...
    static let lockImageName = "GenerateKeyImage"
...
//        titleLabel.constrain([animationConstraint, leading, trailing, titleLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: 0),
//            titleLabel.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: -(screensize.height/4 + 20))
//        ])
