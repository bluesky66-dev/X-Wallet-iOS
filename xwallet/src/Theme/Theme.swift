...
class Theme: BRDTheme {
    ...
    enum ColorHex: String {
        case primaryBackground = "#070618"
        case primaryButtonBackground = "#0b5394"
        case secondaryButtonBackground = "#e69138"
        ...
        VStack {
            ...
            Group {
                HStack {
                    ...
                    self.colorRectangle(color: Color(Theme.primaryButtonBackground), label: "primaryButtonBackground")
                    self.colorRectangle(color: Color(Theme.secondaryButtonBackground), label: "secondaryButtonBackground")
                }
                HStack {
